...
const Header = () => {
  ...
  return <header className={`fixed top-0 left-0 right-0 z-50 py-4 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md py-2' : 'bg-transparent py-4'}`}>
      ...
      {/* Mobile Navigation */}
      {isMenuOpen && <nav className="md:hidden bg-white py-4 px-4 shadow-lg">
