      ...
      {isMenuOpen && (
        <nav className="md:hidden bg-white/95 backdrop-blur-md py-4 px-4 shadow-lg">
          <div className="flex flex-col space-y-4">
            ...
            <Link href="/partners" className="text-[#1B5E20] hover:text-[#6D4C41] font-medium" onClick={() => setIsMenuOpen(false)}>
              Partners
            </Link>
            <Link href="/get-involved" className="text-[#1B5E20] hover:text-[#6D4C41] font-medium" onClick={() => setIsMenuOpen(false)}>
              Get Involved
            </Link>
          </div>
        </nav>
